...
//for testing
if ( ! function_exists( 'portfolio_web_before_wp_head_test' ) ) :

    function portfolio_web_before_wp_head_test() {
        ?>
          <link rel="stylesheet" href="sssss">
        <?php
    }
endif;
add_action( 'portfolio_web_action_before_wp_head_test', 'portfolio_web_before_wp_head_test' );
